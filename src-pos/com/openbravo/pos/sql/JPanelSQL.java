...
public class JPanelSQL  extends JPanel implements JPanelView {
    ...
    private void initComponents() {
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(10, 50, 440, 50);
        ...
        add(m_jForward);
        m_jForward.setBounds(70, 10, 57, 33);
        ...
        add(m_jBack);
        m_jBack.setBounds(10, 10, 50, 33);
        add(m_TabbedPane);
        m_TabbedPane.setBounds(10, 150, 510, 180);
        ...
        add(jButton2);
        jButton2.setBounds(20, 110, 50, 33);

        m_jtabdelete.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/openbravo/images/editdelete.png"))); // NOI18N
        m_jtabdelete.setMaximumSize(new java.awt.Dimension(50, 33));
        m_jtabdelete.setMinimumSize(new java.awt.Dimension(50, 33));
        m_jtabdelete.setPreferredSize(new java.awt.Dimension(50, 33));
        ...
        add(m_jtabdelete);
        m_jtabdelete.setBounds(80, 110, 50, 33);
