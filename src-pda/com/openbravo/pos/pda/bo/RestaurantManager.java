...
public class RestaurantManager {
    ...
    public void initTicket(UserInfo user, String id, String name) {
        ticket = new TicketDAO();
        ticket.initTicket(user, id, name);
    }
    ...
    public String findPlaceByticketID(String ticketId) {
        ticket = new TicketDAO();

        return ticket.getTicket(ticketId).getName();
    }
    ...
    public Place findPlaceByName(String name) {
        ...
        return (Place) place.findPlaceByName(name);
    }
    ...
    public BigDecimal getTotalOfaTicket(String place) {
        double total = 0;
        for (TicketLineInfo line : findTicket(place).getLines()) {
