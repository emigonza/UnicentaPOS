...
public void setProperties() {
        ...
        attributes.setProperty("printkb", product.getPrintkb()? "true" : "false");
        attributes.setProperty("sendstatus", product.getSendstatus()? "true" : "false");
    ...
    public String getProperty(String key) {
        System.out.println(attributes.getProperty(key));
